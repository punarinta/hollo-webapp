    ...
    return (
      ...
      h('login-page', null,
        ...
        h('div', {className: 'input'},
          h(Input, {type: 'email', ref: (input) => this.nameInput = input.base, placeholder: 'Email', autofocus: 'autofocus', onKeyUp: this.emailTyped.bind(this)})
        ),
        h('div', {className: 'input'},
          h(Input, {type: 'password', ref: (input) => this.passInput = input.base, placeholder: 'Password', onKeyUp: this.passwordTyped.bind(this)})
        ),
