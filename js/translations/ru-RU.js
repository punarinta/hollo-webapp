$locales['ru-RU'] =
{
  ...
  HI_WELCOME        : 'Добро пожаловать в Hollo',
  HI_GIMME_5        : 'Пока всё настраивается, вот коротко о главном',
  HI_INBOX          : 'Письма от людей и важные сообщения.',
  HI_MUTED          : 'Рассылки, спам, неважное.\nВобщем то, о чём не надо сообщать.',
  HI_SYNCING        : 'Идёт синхронизация',
  HI_SYNCED         : 'Поехали!',
  ...
  CAP_PASSWORD      : 'пароль',
  CAP_TODAY         : 'сегодня',
  CAP_MUTED         : 'Перемещено в ненужное',
  CAP_UNMUTED       : 'Перемещено в нужное',
  CAP_UNDO          : 'Отменить',
